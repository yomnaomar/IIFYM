...
public class activityLogin1 extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onClick(View v) {
        ...
        switch (i) {
            case R.id.btnEmailLoginIn:
                ...
                emailIntent.setClass(context, activityLogin2.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(activityLogin1.this, "Authentication failed.",
    ...
    private void showAlertDialog(String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activityLogin1.this);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(activityLogin1.this, "Connection failed.",
                Toast.LENGTH_SHORT).show();
    }
